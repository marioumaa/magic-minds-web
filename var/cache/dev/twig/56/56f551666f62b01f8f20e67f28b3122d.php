...
class __TwigTemplate_2745f656993c1ed93d7f298bc469b278 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container py-5\">
        ...
        // line 10
        echo twig_escape_filter($this->env, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 10, $this->source); })()), "html", null, true);
        echo "</h1>
    </div>
</div>
...
<div class=\"container-xxl bg-white py-5\" id=\"coursecontent\">
   ";
        // line 30
        $this->loadTemplate("Enfant/cours/_coursecontent.html.twig", "Enfant/cours/courcelist.html.twig", 30)->display($context);
        // line 31
        echo "</div>
    <script src=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("./asset/User/js/coursesearch.js"), "html", null, true);
        echo "\"></script>
";
    ...
    {
        return array (  139 => 32,  136 => 31,  134 => 30,  111 => 10,  107 => 8,  97 => 7,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}", "Enfant/cours/courcelist.html.twig", "C:\\Users\\hp\\Desktop\\MagicMinds\\templates\\Enfant\\cours\\courcelist.html.twig");
    }
}
