...
class __TwigTemplate_5bac567e4c1be55246d974473279aefd extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"classes-item\">
            ...
            // line 7
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images/" . twig_get_attribute($this->env, $this->source, $context["c"], "image", [], "any", false, false, false, 7))), "html", null, true);
            echo "\" alt=\"\">
            </div>
            <div class=\"bg-light rounded p-4 pt-5 mt-n5 mb-3\">
                <a class=\"d-block text-center h3 mt-3 mb-4\" href=\"";
            // line 10
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("enfant.cources", ["id" => twig_get_attribute($this->env, $this->source, $context["c"], "id", [], "any", false, false, false, 10)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "titre", [], "any", false, false, false, 10), "html", null, true);
            echo "
                </a>
    ...
    {
        return array (  84 => 21,  71 => 14,  62 => 10,  56 => 7,  50 => 3,  46 => 2,  43 => 1,);
    }
    ...
    {% endfor %}
</div>", "Visiteur/_serachcontent.html.twig", "C:\\Users\\hp\\Desktop\\MagicMinds\\templates\\Visiteur\\_serachcontent.html.twig");
    }
}
