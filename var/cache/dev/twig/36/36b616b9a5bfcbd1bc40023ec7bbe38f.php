...
class __TwigTemplate_bf7afc114cf20db1bd713e8a4374e7aa extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "<div class=\"container-xxl bg-white py-5\">
    <div  class=\"row\">
        ";
        // line 8
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["courslist"]) || array_key_exists("courslist", $context) ? $context["courslist"] : (function () { throw new RuntimeError('Variable "courslist" does not exist.', 8, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["cl"]) {
            // line 9
            yield "            <div style=\"margin-bottom:40px\" class=\"col-lg-4\">
            ...
            // line 14
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["cl"], "titre", [], "any", false, false, false, 14), "html", null, true);
            yield "</h3></td>
                            <td><h6 style=\"margin-right:4px;\" class=\"mb-1 mt-1\">";
            // line 15
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["cl"], "duree", [], "any", false, false, false, 15), "html", null, true);
            yield " semaines</h6></td>
                        </tr>
                        <tr>
                            <td colspan=\"2\"><p style=\"color:black ;margin:20px\" class=\"fs-7\">";
            // line 18
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["cl"], "description", [], "any", false, false, false, 18), "html", null, true);
            yield "</p></td>
                        </tr>
                    </table>
                </div>
...
";
    ...
    {
        return array (  147 => 24,  135 => 18,  129 => 15,  125 => 14,  118 => 9,  114 => 8,  110 => 6,  100 => 5,  81 => 3,  61 => 2,  38 => 1,);
    }
...
{% endblock %}
", "Visiteur/courcelist.html.twig", "C:\\Users\\mariem\\Desktop\\MagicMinds\\MagicMinds\\templates\\Visiteur\\courcelist.html.twig");
    }
}
