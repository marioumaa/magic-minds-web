...
class __TwigTemplate_2001dafa8ca0ba5f286472116016669f extends Template
{
    private $source;
    private $macros = [];
...
<script>
    ...
    let reclamationChart = new Chart(reclamationCanvas, {
        ...
        data: {
            labels: ";
        // line 38
        yield (isset($context["recColor"]) || array_key_exists("recColor", $context) ? $context["recColor"] : (function () { throw new RuntimeError('Variable "recColor" does not exist.', 38, $this->source); })());
        yield ",
            datasets: [{
                label: 'Nombre de réclamations par type',
                data: ";
        // line 41
        yield (isset($context["recCount"]) || array_key_exists("recCount", $context) ? $context["recCount"] : (function () { throw new RuntimeError('Variable "recCount" does not exist.', 41, $this->source); })());
        yield ",
                backgroundColor: ";
        // line 42
        yield (isset($context["recColor"]) || array_key_exists("recColor", $context) ? $context["recColor"] : (function () { throw new RuntimeError('Variable "recColor" does not exist.', 42, $this->source); })());
        yield ",
            }]
        }
    });
...
";
    ...
    {
        return array (  115 => 42,  111 => 41,  105 => 38,  69 => 4,  59 => 3,  36 => 1,);
    }
...
", "stat/stats.html.twig", "C:\\Users\\mariem\\Desktop\\MagicMinds\\MagicMinds\\templates\\stat\\stats.html.twig");
    }
}
