...
class __TwigTemplate_a415c9f09b281b0fa9de353c3c79ef69 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_facture", ["commandId" => "__commandId__"]);
        yield "';
    </script>
        ...
        \$(document).ready(function() {
            function fetchCommands(term = '', price = '') {
                \$.ajax({
                    url: '";
        // line 37
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("search_commande");
        yield "',
                    type: 'GET',
                    dataType: 'json',
                    data: {
...
";
    ...
    {
        return array (  108 => 37,  74 => 6,  71 => 5,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "commande/commande.html.twig", "C:\\Users\\mariem\\Desktop\\MagicMinds\\MagicMinds\\templates\\commande\\commande.html.twig");
    }
}
